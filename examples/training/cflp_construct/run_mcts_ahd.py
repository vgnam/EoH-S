...
if __name__=="__main__": run_construct_training("cflp_mcts_ahd.yaml","mcts_ahd",build_task,lambda c:MAProfiler(**c),lambda l,p,t,c:MCTS_AHD(llm=l,profiler=p,evaluation=t,**c),hidden_specs,hidden_eval_factory,post_eval_top_k=10)
