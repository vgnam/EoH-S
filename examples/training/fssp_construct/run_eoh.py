...
if __name__=="__main__":run_construct_training("fssp_eoh.yaml","eoh",build_task,lambda c:EoHProfiler(**c),lambda l,p,t,c:EoH(llm=l,profiler=p,evaluation=t,**c),hidden_specs,hidden_eval_factory)
