...
if __name__=="__main__":run_construct_training("fssp_eohs.yaml","eohs",build_task,lambda c:EoHSProfiler(**c),lambda l,p,t,c:EoHS(llm=l,profiler=p,evaluation=t,**c),hidden_specs,hidden_eval_factory)
